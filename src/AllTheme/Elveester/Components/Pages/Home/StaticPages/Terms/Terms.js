    ...
    const DemotermsArr = [
        {
            ...
            desc: "Before using our website located at https://sonasons.optigoapps.com/ and any associated websites linked to it, please read these Terms and Conditions carefully. By accessing or using our website, you agree to be bound by the terms outlined below."
        },
...

        {
            ...
            desc: "Once you place an order on our website, you will receive an order confirmation email. This email does not indicate acceptance of your order. The contract between you and Sonasons is completed only once the product is shipped."
        },
...

        {
            ...
            desc: "We offer multiple shipping options displayed at checkout. Delivery timelines vary depending on location. Sonasons is not responsible for delays caused by courier services, customs, or unforeseen circumstances."
        },
...

        {
            ...
            desc: "All content on this website, including images, logos, text, and designs, is the intellectual property of Sonasons and is protected by applicable copyright and trademark laws. Unauthorized use is strictly prohibited."
        },

        {
            title: "CUSTOMER RESPONSIBILITIES",
            desc: "Customers are responsible for maintaining the confidentiality of their account information and for providing accurate and complete details during transactions. Sonasons is not liable for issues arising from incorrect information."
        },
...

        {
            ...
            desc: "Sonasons shall not be liable for any direct, indirect, incidental, or consequential damages arising from the use of our website or products. Our maximum liability shall not exceed the amount paid for the purchased product."
        },
                ...
                <Container maxWidth="md">
                    ...
                    <Box mb={5} textAlign="center">
                        ...
                        >
                            ...
                            any products. Your access and use of our services indicate acceptance
                            of these terms.
                        </Typography>
                    </Box>
                    ...
                    <Box mt={6} textAlign="center">
                        <Typography variant="caption" color="text.secondary">
                            © {new Date().getFullYear()} Sonasons. All rights reserved.
                        </Typography>
                    </Box>
                </Container>
            </Box>
