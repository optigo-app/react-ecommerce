          ...
          <div className="smiling_Top_header_div3">
            <ul className="nav_ul_shop">
              <li
                ...
                style={{ cursor: "pointer" }}
                onClick={(event) => {
                  const Url = theme === "ellior" ? "custom-orders" : "/aboutUs"
                  hanldeStaticPageNavigation(event, Url)
                }
                }
              >
                {theme === "ellior" ? <>
                  {islogin && <>
                    <a href="/custom-orders" className="smr_A_link">
                      CUSTOM ORDER
                    </a>
                  </>
                  }
            ...
            <div className="smiling_Top_header_div3">
              <ul className="nav_ul_shop">
                ...
                >
                  {theme === "ellior" ? <>
                    {islogin && <>
                      <a href="/custom-orders" className="smr_A_linkFixed">
                        CUSTOM ORDER
                      </a>
                    </>}
                  </>
