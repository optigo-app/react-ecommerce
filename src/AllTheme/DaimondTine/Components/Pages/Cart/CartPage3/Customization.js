    ...
    <>
      {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
        <div className="dt3_CartCusto_R-details">
          <p className='dt3_cart-Titleline'>{selectedItem?.designno != "" && selectedItem?.designno}{formatTitleLine(selectedItem?.TitleLine) && " - " + selectedItem?.TitleLine}</p>
        ...
        <div className="dt3_CartCusto_R-details">
          <p className='dt3_cart-Titleline'>{formatTitleLine(selectedItem?.TitleLine) && selectedItem?.TitleLine}</p>
          <Divider className='dt3_dividerline' />
