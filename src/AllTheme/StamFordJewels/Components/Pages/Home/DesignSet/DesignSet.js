...
const DesignSet = () => {
    ...
    return (
        <div className="stam_designSetMain">

            <p className='stam_desognSetTitle'>Complete Your Look
                <Link className='stam_designSetViewmoreBtn' onClick={handleNavigate}>
                    View more
                </Link>
            </p>
            <div className='stam_designSetMainDiv'>
                <div className='stam_designSetDiv1'>
                    <img className="stam_designSetDiv1_img" loading="lazy" src={`${imageUrl}${designSetList[0]?.designsetuniqueno}/${designSetList[0]?.DefaultImageName}`} onClick={() => handleNavigation(designSetList[0]?.designno, designSetList[0]?.autocode, designSetList[0]?.TitleLine ? designSetList[0]?.TitleLine : '')} />
                </div>
                <div className='stam_designSetDiv2'>
                    {itemsToShow?.map((slide, index) => (
                        <div className="stam_designSetDiv" key={index}>
                            ...
                            />
                            <p className="stam_designList_title">{slide?.TitleLine}</p>
                        </div>
                    ))}
                    {!showAll && itemsToShow?.length > 6 && (
                        <p className='stam_designSetImageViewAll' onClick={handleViewAll}>View All</p>
                    )}
                </div>
...
//     return (
//         <div className='stam_designSetMain' style={{ position: 'relative' }}>
//             <div>
...
//                             <div className='stam_designsetDiv'>
//                                 <div className='stam_designsetDivImg'>
...
//             <p className='stam_designSetShowAll'>View All</p>
//         </div>
//     )
// }
