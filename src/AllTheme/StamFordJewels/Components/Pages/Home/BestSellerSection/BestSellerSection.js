            ...
            <Slider {...settings} >
                                {chunkedData.map((chunk, index) => (
                                        <div className='linkRingLove'>
                                            ...
                                            <div className='stam_bestselerDiv'>
                    ...
                    <p className='stam_BestSallerViewAll' onClick={() =>  navigation(`/p/BestSeller/?B=${btoa('BestSeller')}`)}>SHOP COLLECTION</p>
        </div>
...
//                                     <p className='stam_bestSellerPrice'>$ {bestSellerData[0]?.UnitCost}</p>
//                                 </div>
//                             </div>
//                             <div>
