...
const DesignSet2 = () => {
  ...
  return (
    <>
      <div className="roop_DesignSet2MainDiv">
        {designSetList?.length !== 0 && (
          <>
            <div className='roop_DesignSetTitleDiv'>
              <p className='roop_desognSetTitle'>Complete Your Look
                <Link href="/Lookbook" className='roop_designSetViewmoreBtn'>
                  View more
                </Link>
              </p>
            </div>
                          ...
                          {parseDesignDetails(slide?.Designdetail)?.map((detail, subIndex) => (
                            <SwiperSlide key={`detail-${detail?.id}`}>
                              <div className="centerall">
                                <div className="roop_ds2ImageDiv">
                                  <img
                                    loading="lazy"
