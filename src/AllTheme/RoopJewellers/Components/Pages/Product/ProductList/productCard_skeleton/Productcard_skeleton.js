...
const ProductCard_Skeleton = ({ fromPage }) => {
    ...
    return (
        <div className='roop_productCard_SkeltenShow'>
            <Grid container spacing={2} style={{ display: 'flex', justifyContent: 'center', width: '100% !important', marginTop: '40px' }}>
                ...
                {cardsArray.map((item) => (
                    <Grid item xs={isMobile ? 6 : 3} key={item} className='roop_productCard_skle_Main'>
                        <Card className="roop_productCard_listpage">
