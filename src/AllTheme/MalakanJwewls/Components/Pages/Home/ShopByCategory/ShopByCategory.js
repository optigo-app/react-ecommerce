                ...
                <div style={{
                    ...
                    <div className='shopByCategoryBox1Main'>
                        <div className='shopByCategoryBox'>
                            ...
                            <p className='mala_shopByCateTitle' style={{ fontWeight: 500, textAlign: 'center' }}>EARRING</p>
                        </div>
                        <div className='shopByCategoryBox'>
                            <img src={`${storImagePath()}/images/HomePage/shopByCategory/shopByCategory2.png`} className='shopByCategoryBoxImg' />
                            <p className='mala_shopByCateTitle' style={{ fontWeight: 500, textAlign: 'center' }}>NACKLACES</p>
                        </div >
                    </div>
                    <div className='shopByCategoryBox2Main'>
                        <div className='shopByCategoryBox'>
                            ...
                            <p className='mala_shopByCateTitle' style={{ fontWeight: 500, textAlign: 'center' }}>PENDANT</p>
                        </div>
                        <div className='shopByCategoryBox'>
                            <img src={`${storImagePath()}/images/HomePage/shopByCategory/shopByCategory4.png`} className='shopByCategoryBoxImg' />
                            <p className='mala_shopByCateTitle' style={{ fontWeight: 500, textAlign: 'center' }}>RING</p>
                        </div>
                    </div>
                </div>
            </div>
