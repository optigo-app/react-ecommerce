...
const ProductDetail = () => {
  ...
  console.log("kiki", (singleProd?.TitleLine?.toLowerCase() !== "null" || singleProd?.TitleLine?.toLowerCase() !== null))

  return (
    <>
      <Helmet>
        <title>
          {singleProd?.TitleLine && singleProd.TitleLine.toLowerCase() !== "null"
                    ...
                    <div className="roop_prod_shortInfo">
                      ...
                      <div className="roop_prod_shortInfo_inner">
                        <p className="roop_prod_titleLine">
                          {(singleProd?.TitleLine && singleProd?.TitleLine?.toLowerCase() !== "null") && singleProd?.TitleLine}
                        </p>
