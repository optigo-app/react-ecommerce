    ...
    return (
        <div>
            {newArrivalData?.length != 0 &&
                <div className='for_NewArrivalMain'>
...
//                         <div className='for_newArrivaldivMain'>
//                             <div className='for_newArrialDiv1' onClick={() => handleNavigation(newArrivalData[0]?.designno, newArrivalData[0]?.autocode, newArrivalData[0]?.TitleLine)}>
...
//                                 <p className='for_nwArrivalTitle'>{newArrivalData[0]?.TitleLine}</p>
//                                 <p className='for_nwArrivalTitle'><span
...
//                             </div>
//                             <div className='for_newArrialDiv1' onClick={() => handleNavigation(newArrivalData[1]?.designno, newArrivalData[1]?.autocode, newArrivalData[1]?.TitleLine)}>
...
//                                 <p className='for_nwArrivalTitle'>{newArrivalData[1]?.TitleLine}</p>
//                                 <p className='for_nwArrivalTitle'><span
//                                     className="for_currencyFont"
//                                     dangerouslySetInnerHTML={{
//                                         __html: decodeEntities(
