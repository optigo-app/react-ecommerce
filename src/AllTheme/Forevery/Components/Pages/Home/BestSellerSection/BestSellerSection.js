            ...
            <Slider {...settings} >
                                {chunkedData.map((chunk, index) => (
                                        <div className='linkRingLove'>
                                            ...
                                            <div className='for_bestselerDiv'>
                    ...
                    <p className='for_BestSallerViewAll' onClick={() =>  navigation(`/p/BestSeller/?B=${btoa('BestSeller')}`)}>SHOP COLLECTION</p>
        </div>
...
//                                     <p className='for_bestSellerPrice'>$ {bestSellerData[0]?.UnitCost}</p>
//                                 </div>
//                             </div>
//                             <div>
