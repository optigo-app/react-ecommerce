        ...
        {(!selectedItem?.hasOwnProperty(keyToCheck)) ? (
          <>
            {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0 && selectedItem?.Sol_StockNo == "") ? (
              <div className="forMo_Cart_R-details">
                <p className='forMo_cart-Titleline'>{selectedItem?.TitleLine}</p>
                <Divider />
                {storeInitData?.IsProductWebCustomization == 1 &&
                  <div className="forMo_Cart-options">
                ...
                <div className='forMo_cartQtyPricemainDev'>
                  ...
                  {storeInitData?.IsPriceShow == 1 &&
                    <div className="product-price">
                      {!ispriceloding ? (
                        ...
                        <Skeleton className='forMo_CartSkelton' variant="text" width="80%" animation="wave" />
                      )}
                    </div>
                  }
                </div>
                <div className='forMo_UpdateCartBtn'>
                  <Button className="forMo_cartUpdate-button" onClick={() => handleUpdateCart(selectedItem)}>Save</Button>
                </div>
                <div className='forMo_CloseIcon' onClick={handleClose}>
                  <CloseIcon />
                </div>
              </div>
            ) :
              <div className="forMo_CartCusto_R-details">
                <p className='forMo_cart-Titleline'>{selectedItem?.TitleLine}</p>
                <Divider />
                ...
                <div className="forMo_StockCart-options">
                ...
                <div className="forMo_stockPriceQtyDiv">
                  <div className="option">
                  ...
                  <div className=''>
                    {storeInitData?.IsPriceShow == 1 &&
                      <div className="forMo_Stockproduct-price">
                        {!ispriceloding ? (
                          <span>
          ...
          <div className="forMo_CartCusto_R-details">
            <p className='forMo_cart-Titleline'>
              <span>
                {selectedItem?.carat}{" "}
            ...
            <Divider className='forMo_dividerline' />
            <div className="forMo_stockPriceQtyDiv">
              <div className="option">
              ...
              <div>
                {storeInitData?.IsPriceShow == 1 &&
                  <div className="forMo_Stockproduct-price">
                    {!ispriceloding ? (
                      <span>
                        <span className="forMo_currencyFont">{loginInfo?.CurrencyCode ?? storeInitData?.CurrencyCode}</span>&nbsp;
