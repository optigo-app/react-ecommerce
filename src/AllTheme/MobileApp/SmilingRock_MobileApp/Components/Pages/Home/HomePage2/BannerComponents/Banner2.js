...
import { smrMA_logoColor } from '../../../../Recoil/atom'; // Update path as needed
        ...
        >
            ...
            <div style={{ padding: '16px', width: "95%", marginInline: "auto" }}>
                ...
                <p style={{ color: '#777', marginTop: '8px' }}>
                    Explore the latest additions to our collection — fresh styles crafted to elevate your everyday look.
                </p>
            </div>
        </motion.div>
    );
